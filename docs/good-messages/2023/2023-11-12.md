# [<](2023-11-11.md) 2023-11-12 [>](2023-11-13.md)
...
---
## [QWOD/DISCLOSURE](https://github.com/QWOD/DISCLOSURE)@[3244562697...](https://github.com/QWOD/DISCLOSURE/commit/324456269756e3beae1150b8af55958ee73ecfb8)
...
---
## [zwilder/GoblinCaves](https://github.com/zwilder/GoblinCaves)@[5fbb27489f...](https://github.com/zwilder/GoblinCaves/commit/5fbb27489f7cbb55ee1a92847a25dd4089a94961)
...
okay, hardly anything written today, BUT, learned a bit about modals, which is how ill handle the compare popup, and holy shit i just realized how much work is gonna be needed here... fucking author keys!
...
9. ko - 간단하고 빠르고 안전한 Go용 이미지 빌더  (ko.build)
- https://ko.build/
...
28. Email 난독화는 ChatGPT앞에 거의 무용지물 (bulkninja.notion.site)
...
FUCK YOU WHAT THE FUCKMerge branch 'main' of https://github.com/suv-900/improved-clouds
...
---
## [TheParasiteProject-Devices/kernel_sony_sm8550](https://github.com/TheParasiteProject-Devices/kernel_sony_sm8550)@[558e8eff1e...](https://github.com/TheParasiteProject-Devices/kernel_sony_sm8550/commit/558e8eff1ebc6efa1bfcf6b7dcd67db3715e1d3c)
...
---
## [treckstar/yolo-octo-hipster](https://github.com/treckstar/yolo-octo-hipster)@[9088f155d2...](https://github.com/treckstar/yolo-octo-hipster/commit/9088f155d27de99fd683ab5db8f2d1c47079d50d)
#### Sunday 2023-11-12 12:22:04 by treckstar

Life is one big road with lots of signs. So when you riding through the ruts, don't complicate your mind. Flee from hate, mischief and jealousy. Don't bury your thoughts, put your vision to reality. Wake Up and Live!

---
## [maximpn/kibana](https://github.com/maximpn/kibana)@[cd909f03b1...](https://github.com/maximpn/kibana/commit/cd909f03b1d71da93041a0b5c184243aa6506dea)
#### Sunday 2023-11-12 14:25:48 by Kyle Pollich
...
---
## [thisismy-github/instant-replay-suite](https://github.com/thisismy-github/instant-replay-suite)@[64c11ff86c...](https://github.com/thisismy-github/instant-replay-suite/commit/64c11ff86c03058958caaf4b5217e7a65f6f77fa)
#### Sunday 2023-11-12 14:42:54 by thisismy-github

Added `Icon.reopen_in_place()` to fix index desync

Uses `WM_CANCELMODE` and `WM_NOTIFY` signals to manually close and
reopen the menu, along with new `Icon.is_open` and `Icon.last_pos`
properties so we know when our menu is open and can reopen from the
same position, making it look like the menu refreshed itself. Added
a `force` parameter and `Icon.close()` for good measure, though
they'll stay unused for now.

Doing this saves us from the headaches caused by clips being added while
the menu is open, which causes actions to affect the wrong clips since
our menu items are based on indexes rather than raw paths. Accordingly,
`self.check_for_clips_thread()` has been slightly reworked to better
protect against index desyncing.

---

This commit originally reused the COM interface trick from PyPlayer to
send a fake `Alt` press to the menu to close it (without reopening it).
The only reason I continued trying to figure out how to close/reopen
correctly (which I knew was possible) was because I got a bit paranoid
about anti-cheat, even though I'm 99.99% sure COM interfaces to other
programs while a game is alt-tabbed would never trigger false-positives.

You can never be too paranoid.

The second version also used `GetForegroundWindow()` instead of adding
`Icon.is_open`, but it proved too unreliable (stays True until you click
something outside of the menu). Fingers crossed for the property.

---
## [Wahn128/Flexible-Survival](https://github.com/Wahn128/Flexible-Survival)@[39ee125792...](https://github.com/Wahn128/Flexible-Survival/commit/39ee125792415b02fbc94c75c66b797c70fa908f)
#### Sunday 2023-11-12 15:13:52 by Sundered-Dragon
...
---
## [RisenID/device_samsung_sm7125-common](https://github.com/RisenID/device_samsung_sm7125-common)@[04bdb41dad...](https://github.com/RisenID/device_samsung_sm7125-common/commit/04bdb41dad34f49d8aaf23fe1b2b7b401c7e3ab7)
#### Sunday 2023-11-12 15:29:22 by Ruchit

Revert "(note to self) dont pick this ye dumb idiot its only for wip branch so you can test shit better k bye"

This reverts commit 115918a83d18ce4670c8c16091f40a2b40a9b895.

---
## [mamedev/mame](https://github.com/mamedev/mame)@[65ec4542ca...](https://github.com/mamedev/mame/commit/65ec4542ca3c0092247ebcab86d21eff987e4472)
#### Sunday 2023-11-12 15:47:00 by wilbertpol
...
---
## [AlbionOfDarkness/Shiptest](https://github.com/AlbionOfDarkness/Shiptest)@[70463ae71b...](https://github.com/AlbionOfDarkness/Shiptest/commit/70463ae71b7d639eecea572d3251562c5ffef68b)
#### Sunday 2023-11-12 16:07:39 by Mirag1993
...
---
## [ProjectIgnis/BabelCDB](https://github.com/ProjectIgnis/BabelCDB)@[3251aaac54...](https://github.com/ProjectIgnis/BabelCDB/commit/3251aaac54c636df92d5c6874b8462d61377e9b3)
#### Sunday 2023-11-12 16:34:22 by pyrQ

Added new cards

The "V Jump January 2024" promo:
...
From "Quarter Century Duelist Box":
- Supreme King Z-ARC - Synchro Universe
- Code of Soul
From "Legacy of Destruction":
...
From "Promotion Pack 2024":
- Mirah and Matchnoko
- A★Speculation

---
## [ilikegoodfood/Orcs-Plus](https://github.com/ilikegoodfood/Orcs-Plus)@[eef8f34aaf...](https://github.com/ilikegoodfood/Orcs-Plus/commit/eef8f34aafc3f910dea637f84810d2ed75ea91a1)
#### Sunday 2023-11-12 17:24:56 by ilikegoodfood

Bugfixes and Expansionism Boost

Feature Updates:
- Doubled damage dealt by Vinerva's "Thorn Wall" property.
- If the Expansionism tenet is fully elder aligned (-2), orc hordes, spelltwister hordes, and orc corsairs will build new camps using the "Build Camp" ritual, if they find themselves in a valid location, such as after completely razing an enemy settlement, and there are no armies for them to attack instead. If the orc society has a shipyard, this will allow them to build on disconnected coastlines.

Bugfixes:
- The power's gained from Vinerva's god specific tenet now properly check if they are within range of a heart of the forest.
- Vinera's "Sapling of Life" power now checks against all waystations in each neighbouring location instead of only the first.
- Vinerva's "Sapling of Life" power must now be adjacent to an orc camp or waystation of a valid culture, not just next to orc territory of a valid culture.
- Fixed collection modified error that occurs when Vinerva's "Thorn Wall" property kills an army.
- A location with an Orchard of Life is no longer a valid target for the "Sapling of Life" power.
- The "Build Camp" ritual is now only valid if neighbouring an orc camp or waystaion of a matching orc society, instead of simply needing to be neighbouring the matching orc society.

---
## [nikothedude/tgstation](https://github.com/nikothedude/tgstation)@[f3d81edb00...](https://github.com/nikothedude/tgstation/commit/f3d81edb00b07160bc046ab0d79457e60aefba0e)
#### Sunday 2023-11-12 18:12:42 by Paxilmaniac
...
---
## [nikothedude/tgstation](https://github.com/nikothedude/tgstation)@[eb9da97b7d...](https://github.com/nikothedude/tgstation/commit/eb9da97b7da54f9bdce32aa29ec972f469625ed2)
#### Sunday 2023-11-12 18:12:42 by GoldenAlpharex
...
---
## [ReezeBL/Skyrat-tg](https://github.com/ReezeBL/Skyrat-tg)@[3bc191272a...](https://github.com/ReezeBL/Skyrat-tg/commit/3bc191272ac234ad78a0aa8b9e1d1e10f32ff7f1)
#### Sunday 2023-11-12 18:20:18 by SkyratBot
...
---
## [nikothedude/tgstation](https://github.com/nikothedude/tgstation)@[d31c21ff1b...](https://github.com/nikothedude/tgstation/commit/d31c21ff1b57ba7003f9bbdcf51171d3215a0774)
#### Sunday 2023-11-12 18:28:39 by jimmyl
...
---
## [nikothedude/tgstation](https://github.com/nikothedude/tgstation)@[9e18c6575a...](https://github.com/nikothedude/tgstation/commit/9e18c6575a3cb9e73c3e699d4fe51b904b76e2f6)
#### Sunday 2023-11-12 18:28:39 by lizardqueenlexi
...
---
## [mrakgr/The-Spiral-Language](https://github.com/mrakgr/The-Spiral-Language)@[7ece1d2d26...](https://github.com/mrakgr/The-Spiral-Language/commit/7ece1d2d268aa60882326be007353062a94801e4)
#### Sunday 2023-11-12 18:34:12 by mrakgr
...
---
## [Physolia/carbon-lang](https://github.com/Physolia/carbon-lang)@[c7e6238fa8...](https://github.com/Physolia/carbon-lang/commit/c7e6238fa8dd57672b0765e738f4c425a27cac3b)
#### Sunday 2023-11-12 18:52:17 by Chandler Carruth
...
---
## [Dedicatus5457/android_kernel_xiaomi_mt6785](https://github.com/Dedicatus5457/android_kernel_xiaomi_mt6785)@[2f7704b681...](https://github.com/Dedicatus5457/android_kernel_xiaomi_mt6785/commit/2f7704b68172d3deb215d73c3a9b51dda3517e78)
#### Sunday 2023-11-12 19:06:42 by Peter Zijlstra
...
#### Sunday 2023-11-12 19:12:51 by necromanceranne
...
#### Sunday 2023-11-12 19:12:51 by zxaber
...
---
## [Physolia/react](https://github.com/Physolia/react)@[1ebedbec2b...](https://github.com/Physolia/react/commit/1ebedbec2bec08e07c286ea6c3cff62737a0fd3a)
#### Sunday 2023-11-12 20:35:37 by Sebastian Markbåge
...
#### Sunday 2023-11-12 20:49:17 by SpartanKadence
...
#### Sunday 2023-11-12 20:49:51 by SpartanKadence
...
#### Sunday 2023-11-12 21:36:35 by Waterpig
...
---
## [psathyrella/partis](https://github.com/psathyrella/partis)@[81504265f3...](https://github.com/psathyrella/partis/commit/81504265f321831d660fdafe6526900f07fdee83)
#### Sunday 2023-11-12 21:42:05 by duncan ralph

rerun dict fixer, except instead of painstakingly going through

and reverting the unnecessary changes, this time keep all of them
since apparently numpy can't handle dict views so what fucking
ever just convert everything to lists. This is so fucking stupid.

---
## [v7-c/wagnerstation](https://github.com/v7-c/wagnerstation)@[053e66b0d3...](https://github.com/v7-c/wagnerstation/commit/053e66b0d36700f6e55a15290cf2f853a1a6d58e)
#### Sunday 2023-11-12 22:04:58 by necromanceranne
...
#### Sunday 2023-11-12 22:46:55 by Coxswain
...
---
## [MiszczTheMaste/equestria_dev](https://github.com/MiszczTheMaste/equestria_dev)@[0c55aebcae...](https://github.com/MiszczTheMaste/equestria_dev/commit/0c55aebcae844d845ab72d6a9fc2e428290d6d59)
#### Sunday 2023-11-12 23:26:29 by Mustafa Alperen Seki
...
---
## [unikorm/pluginToAcceptCokkies](https://github.com/unikorm/pluginToAcceptCokkies)@[da3a349fce...](https://github.com/unikorm/pluginToAcceptCokkies/commit/da3a349fcec1edcf172dd99d9fa563372ca81294)
#### Sunday 2023-11-12 23:47:39 by unikorm

finnaly find some relevant stuff on this not only gpt, so what i have now is absolutely shit, bad, for nothing, i find code on gh to real extension what do this and it is fucking big so, i try to do something, but idk what it would be, now i think it will be fun to create something that in console it show automatically when you are at some website what data from your browser/machine are website took from you, that will be better i think
