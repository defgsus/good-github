...
149,262 events, 83,110 push events, 115,770 commit messages, 6,450,444 characters
...
---
## [sorbet/sorbet](https://github.com/sorbet/sorbet)@[edde0ec9de...](https://github.com/sorbet/sorbet/commit/edde0ec9def78d6ca283ecd62fafd99ae52350ac)
#### Sunday 2020-12-20 23:58:08 by Jake Zimmerman

Fix some use-after-free errors

Since `underlying` is computed on the fly now, if it's not stored by the
caller, it's dropped immediately. So if you try to get the underlying
and immediately cast it to something, it will destruct before you have
a chance to make use of the downcast value.

This is super annoying, and I'm glad it came up in our test case, but I
would love to figure out how to make it a compile error.
